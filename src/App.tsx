...
function App() {
  ...
  return (
    <div>
      ...
      <iframe style={{ display: currentView == 0 ? 'flex' : 'none', border: "0", margin: 0, padding: 0, width: "100vw", height: "92vh", position: "absolute", top: '8vh', left: 0 }} src='https://marcuscodewriter.github.io/fluttermix'></iframe>
